...
import 'package:flutter_retos/reto1/grocery_store_bloc.dart';
import 'package:flutter_retos/reto1/grocery_store_list.dart';

const _backgroundColor = Color(0xFFF6F5F2);
const _cartBarHeight = 120.0;
const _panelTransition = Duration(milliseconds: 500);

class HomeReto extends StatefulWidget {
  const HomeReto({Key key}) : super(key: key);

  @override
  _HomeRetoState createState() => _HomeRetoState();
}

class _HomeRetoState extends State<HomeReto> {
